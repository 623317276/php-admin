...
(function($) {
	...
	$.tbox.showDiv = function(data) {
		$.tbox.init();
		$.tbox.loading();
		var k="<div id=\"tboxBody\">";
		k+=data;
		k+="</div>";
		$.tbox.reveal(k);
	}
	
	$.tbox.showDiv2 = function(data) {
		$.tbox.init();
		$.tbox.loading();
		var k="<div id=\"tboxBody\">";
		k+="</div>";
		$.tbox.reveal(k);
		$(data).appendTo("#tboxBody");
	...
	$.tbox.settings = {
			...
			<div id="tbox" style="display:none;"> \
				<table class="popup" align="center" border="0" border="0" cellpadding="0" cellspacing="0"><tr><td> \
				  <div class="body"> \
					<div id="tbox_content" class="content" class="out"></div> \
				  </div> \
				</td></tr></table> \
			</div> \
		...
		*/
		...
		$.tbox.settings = {
			...
			<div id="tbox" style="display:none;"> \
				  <div class="body"> \
					<div id="tbox_content" class="out"></div> \
				  </div> \
			</div> \
			<div id="tbox_background" class="tbox_background" style="display:none;"></div> \ '
		}
