	 ...
	 function searchButton(){
	    var rankid = $('#rankid').val();//电话
	 	...
	 	$.ajax({ 
            type : "POST", 
            url : "/index.php/Manage_admin/adminajax", 
	 ...
	 function pageTagCallBack(data){
		...
		DMGold.PageTag.init({"divId":"pageId","formId":"dataForm","curPage":data.pageResult.pageIndex,"totalCount":data.pageResult.recordCount,
				          "pageCount":data.pageResult.pageTotal,"url":"/index.php/Manage_admin/adminajax","toPageCallBack":pageTagCallBack});
		}
	  }
	  //商品排序
            	...
            	if(result.code == "000000"){
            		dm.alert("操作成功！",{
            			...
            			callback:function(){	//按确定后执行的函数
            				window.location.href="promotionTempalete";
            			}
            		});
              	}else{
	 ...
	 //新增用户
  	function addPerUserSubmit(){
  		...
  		$.ajax({ 
            type : "POST", 
            url : "/index.php/Manage_admin/adminadd", 
