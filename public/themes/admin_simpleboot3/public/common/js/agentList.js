	 ...
	 function search(){
	 	DMGold.ajax({"formId":"dataForm","serialize":true,"url":"/Manage_Agent/agentajax","success":pageTagCallBack});
	 }
	 ...
	 function pageTagCallBack(data){
		...
		DMGold.PageTag.init({"divId":"pageId","formId":"dataForm","curPage":data.pageResult.pageIndex,"totalCount":data.pageResult.recordCount,
				          "pageCount":data.pageResult.pageTotal,"url":"/Manage_Agent/agentajax","toPageCallBack":pageTagCallBack});
		}
	  }
	  //商品排序
