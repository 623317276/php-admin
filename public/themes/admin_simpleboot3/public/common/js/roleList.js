	 ...
	 function search(){
	 	DMGold.ajax({"formId":"dataForm","serialize":true,"url":"/index.php/Manage_admin/roleajax","success":pageTagCallBack});
	 }
	 
	 function searchButton(){
	    var rankid = $('#rankid').val();//电话
	 	...
	 	$.ajax({ 
            type : "POST", 
            url : "index.php/Manage_admin/roleajax", 
            data : {"uname":uname,"name":name,"phoneId":phoneId,"rankid":rankid,"lockFlag":lockFlag,"startTime":startTime,"endTime":endTime}, 
	 ...
	 function pageTagCallBack(data){
		...
		DMGold.PageTag.init({"divId":"pageId","formId":"dataForm","curPage":data.pageResult.pageIndex,"totalCount":data.pageResult.recordCount,
				          "pageCount":data.pageResult.pageTotal,"url":"/index.php/Manage_admin/roleajax","toPageCallBack":pageTagCallBack});
		}
	  }
	  //商品排序
	 ...
	 //锁定/解锁弹出框
 	function lockinfo(userid,islock){
	 ...
	 //新增用户
  	function addPerUserSubmit(){
  		...
  		$.ajax({ 
            type : "POST", 
            url : "/index.php/Manage_agent/agentadd", 
