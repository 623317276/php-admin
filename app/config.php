...
$configs = [
    ...
    'admin_login_check'=>[
        ...
        'redirect_filename'=>'content_manage_login_secret.php',
        'key'=>md5('admin/login_check_client'),
    ],
    // 视图输出字符串内容替换
    'view_replace_str'        => [],
    // 默认跳转页面对应的模板文件
    ...
    // 服务器地址
    'hostname' => '127.0.0.1', 
    //'hostname' => 'rm-j6c80f23kr3qwiv9d3o.mysql.rds.aliyuncs.com', 
    // 数据库名
    'database' => 'capital',
    // 用户名
    'username' => 'capital',
    // 密码
    'password' => 'yWXfE7jhp4ncBJwe',
    // 端口
    'hostport' => '3306',
    // 数据库编码默认采用utf8
    'charset'  => 'utf8mb4',
