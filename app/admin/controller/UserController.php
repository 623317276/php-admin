...
class UserController extends AdminBaseController
{
        ...
        if ($this->request->isPost()) {
            if (!empty($_POST['role_id']) && is_array($_POST['role_id'])) {
                ...
                // } else {
                    ...
                    $result             = DB::name('adminuser')->insertGetId($_POST);
                    if ($result !== false) {
        ...
        if ($this->request->isPost()) {
            if (!empty($_POST['role_id']) && is_array($_POST['role_id'])) {
                ...
                // if ($result !== true) {
                    ...
                    // $this->error($result);
                // } else {
                    $result = DB::name('adminuser')->update($_POST);
                    if ($result !== false) {
    ...
    public function delete()
    {
        ...
        if (Db::name('adminuser')->delete($id) !== false) {
    ...
    public function ban()
    {
        $id = $this->request->param('id', 0, 'intval');
        if (!empty($id)) {
            $result = Db::name('adminuser')->where(["id" => $id, "user_type" => 1])->setField('user_status', '0');  
            if ($result !== false) {
